...
class Question {
    ...
    public Question(String q, String[] a, int r) throws IllegalArgumentException{
        if (q==null || a==null) 
        ...
        if (r<0|| r>= a.length) 
            throw new IllegalArgumentException ("Attempted to initialize a Question with"
                + "a bad argument for the right answer");
        rightAnswer = r;
    }
    ...
    public boolean isThisTheRightAnswer(int i) throws IllegalArgumentException{
